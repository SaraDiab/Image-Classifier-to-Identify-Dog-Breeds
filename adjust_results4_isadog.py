...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    """           
    dognames_dic = dict()
    get_dogs_name_as_dict_from_file(dogfile, dognames_dic)
    update_results_with_dog_labels(results_dic, dognames_dic)


def get_dogs_name_as_dict_from_file(dogfile, dognames_dic):
    """
...
def update_results_with_dog_labels(results_dic, dognames_dic):
    """
